...
use App\Http\Controllers\Admin\ManuelScolaireController;
use App\Http\Controllers\Admin\DashboardController;
use App\Http\Controllers\Panel\CardReservationController;
use App\User;
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => 'web'], function () {
    Route::get('/users/online-status', function () {
    ...
    Route::get('/card', 'DashboardController@indexCard');
    Route::get('/generate-keys','DashboardController@generateKeys')->name('generate.keys');
    Route::get('/card_reservations', [CardReservationController::class, 'index'])->name('admin.reservations.index');
     Route::post('/reservations/update-status', [CardReservationController::class, 'updateStatus'])
     ->name('admin.reservations.updateStatus');
     Route::delete('/reservations/{id}', [CardReservationController::class, 'destroy'])
    ...
    Route::group(['middleware' => 'admin'], function () {
        Route::get('/scolaire', [ManuelScolaireController::class, 'index'])->name('admin.manuel_scolaire.index');
        Route::get('/', 'DashboardController@index')->name('admin.dashboard');
        Route::get('/clear-cache', 'DashboardController@cacheClear');
        Route::get('/matiere-by-level/{level}', 'UserController@getByLevel');
        Route::post('/generate-keys', [DashboardController::class, 'generateKeys'])
        ->name('admin.generateKeys');
        ...
        Route::group(['prefix' => 'instructors'], function () {
            Route::get('/', 'UserController@instructors')->name('admin.instructors');
        ...
        Route::group(['prefix' => 'supports'], function () {
            ...
            Route::get('/call', 'SupportsController@call_user');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::post('/changestatus/{id}', 'WebinarController@changestatus');
        ...
        Route::group(['prefix' => 'chapters'], function () {
            ...
            Route::post('/{chapterId}/change-status', 'ChapterController@changeStatus');
        });
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            Route::get('/payment-proofs', 'PaymentProofController@index')->name('adminPaymentProofs');
            Route::post('/payment-proofs/{id}', 'PaymentProofController@updateStatus')->name('adminPaymentProofsUpdate');
        });
        ...
        Route::group(['prefix' => 'regions'], function () {
            Route::get('/newcreate', 'RegionController@createregionsmanualscolaire');
            Route::post('/newcreatepost', 'RegionController@createregionsmanualscolairepost')->name('regions.create');

            Route::get('/newadd', 'RegionController@addsmanualscolaire');
            Route::get('/newindex', 'RegionController@indexsmanualscolaire');
