...
@section('content')
    ...
    <div class="container" style="margin-top:200px ">
        <section class="">
            <div class="contact-map" id="contactMap" data-latitude="{{ $contactSettings['latitude'] }}"
                data-longitude="{{ $contactSettings['longitude'] }}" data-zoom="{{ $contactSettings['map_zoom'] ?? 12 }}">
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        <div
                            class="contact-icon-box box-info p-20 d-flex align-items-center justify-content-center mx-auto">
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        <div
                            class="contact-icon-box box-green p-20 d-flex align-items-center justify-content-center mx-auto">
    ...
    <p dir="ltr" class="font-weight-500 text-gray font-14 mt-10">
        {!! nl2br(str_replace(',', '<br/>', e($contactSettings['phones']))) !!}
    </p>
@else
    <p class="font-weight-500 text-gray font-14 mt-10">{{ trans('site.not_defined') }}</p>
@endif
        ...
        <section class="mt-30 mt-md-50">
            <h2 class="font-16 font-weight-bold text-secondary" id="contactForm">{{ trans('site.send_your_message_directly') }}</h2>
            ...
            <form action="/contact/store#contactForm" method="post" class="mt-20">
                {{ csrf_field() }}
