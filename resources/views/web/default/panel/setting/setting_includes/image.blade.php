<section class="d-flex justify-content-center p-15 panel-shadow bg-white rounded-sm m-20">
    <div class="row mt-20">
        <div class="col-12">
            <div class="form-group">
                ...
                <img src="{{ !empty($user) ? $user->getAvatar(150) : '' }}" alt="" id="profileImagePreview"
                    width="150" height="150" class="rounded-circle my-15 d-block ml-5">

                <button id="selectAvatarBtn" type="button" class="btn btn-sm btn-secondary select-image-cropit"
                    data-ref-image="profileImagePreview" data-ref-input="profile_image">
        ...
        @if ($user->isteacher())
            <div class="col-12 col-lg-4">
                <div class="form-group">
                    ...
                    <img src="{{ !empty($user) ? $user->getCover() : '' }}" alt="" id="profileCoverPreview"
                        height="150" class="rounded-sm my-15 d-block w-100">

                    <div class="form-group">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <button type="button" class="input-group-text panel-file-manager"
                                    data-input="cover_img" data-preview="holder">
                                    <i data-feather="arrow-up" width="18" height="18" class="text-white"></i>
                                </button>
                            </div>
                            <input type="text" name="cover_img" id="cover_img"
                                value="{{ !empty($user) ? $user->cover_img : old('cover_img') }}" class="form-control "
