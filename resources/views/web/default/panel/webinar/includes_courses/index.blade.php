...
<style>
    ...
    bottom: 0;
    opacity: 0.6;
    background-color: #1b1b1b2b!important;
}
    </style>
    <section style="height:348px;background-color: #1b1b1b2b!important;" class="course-cover-container {{ empty($activeSpecialOffer) ? 'not-active-special-offer' : '' }}">
