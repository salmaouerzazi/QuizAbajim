...
<script defer src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <div class="container mt-4">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('panel.quiz.upload') }}">
            @csrf
            <div class="rounded"
                style="max-width: 750px; margin: auto; background: #f2f9fc; border: 2px dashed #6490ab; padding: 50px 30px;">

                <!-- Zone Upload -->
                <div id="dropzone" class="text-center mb-5 p-5 rounded"
                    ...
                    <p class="text-muted mb-3">ملف .PDF، بحجم لا يتجاوزmo 250</p>

                    <input type="file" name="pdf" id="fileInput" accept="application/pdf" class="d-none"
                        onchange="updateFileName(this)">
                    <div id="fileName" class="mt-3 text-success fw-bold"></div>
                </div>

                <!-- Paramètres -->
                <div class="d-flex justify-content-between align-items-end text-center mt-4 pt-4 border-top"
                    style="border-color: #a5d6e8; flex-wrap: wrap; gap: 20px;">
                    <div class="flex-fill">
                        <label class="d-block mb-2" style="color: #004c70;">عدد الأسئلة</label>
                        <input type="number" id="questionCount" name="num_questions" class="form-control text-center"
                ...
                <div class="text-center mt-4">
                    <button type="submit" id="submitButton" class="btn btn-primary px-5 rounded-pill"
