...
<div class="row">
    ...
    <div  id="style-ebBB1">
      <div class="DAVP1">
        <ol class="bc7Xde">
          <li>
            <a class="q9yZOe style-JxznW" href="" id="style-JxznW">
              <div>
          ...
          <li>
            <a class="q9yZOe style-N3U2Y" href="" id="style-N3U2Y">
              <div>
          ...
          <li>
            <a class="q9yZOe style-oQd4Z" href="" id="style-oQd4Z">
              <div>
          ...
          <li>
            <a class="q9yZOe style-d2o4t" href="" id="style-d2o4t">
              <div>
          ...
          <li>
            <a class="q9yZOe style-VIP4d" href="" id="style-VIP4d">
              <div>
          ...
          <li>
            <a class="q9yZOe style-vgVaC" href="" id="tsuid_42">
              <div>
                ...
                <div class="col-sm-4">
                    <a class="X5OiLe vGvPJe" href="#VIDEOOPENID">
                        <div class="WM9LLd" style="margin-top:10px">
                            <div>
                                <video width="660" height="125" controls>
    ...
    <div class="col-lg-1" style="padding-left: 0px;padding-right: 10px!important;   ">
