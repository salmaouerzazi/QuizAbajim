                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="/admin/webinars/{{ !empty($webinar) ? $webinar->id.'/update' : 'store' }}" id="webinarForm" class="row  webinar-form">
                                {{ csrf_field() }}
                                <div class="col-6">
                                    <section>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-12">
                                                ...
                                                <div class="form-group mt-15">
                                                 ...
                                                 <div class="form-group mt-15">
                                                    ...
                                                    <select name="level" class="form-control @error('level') is-invalid @enderror">
                                                        <option value="" disabled {{ empty($webinar) ? 'selected' : '' }}>{{ trans('public.select_level') }}</option>
                                                        @foreach($levels as $level)
                                                            <option value="{{ $level->id }}" {{ (!empty($webinar) && $webinar->level_id == $level->id) ? 'selected' : '' }}>{{ $level->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('level')
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="form-group mt-15">
                                                    <label class="input-label">{{ trans('public.material') }}</label>
                                                    <select name="material_id" class="form-control @error('material_id') is-invalid @enderror">
                                                        <option value="" disabled {{ empty($webinar) ? 'selected' : '' }}>{{ trans('public.select_material') }}</option>
                                                        @foreach($materials as $material)
                                                            <option value="{{ $material->id }}" {{ (!empty($webinar) && $webinar->material_id == $material->id) ? 'selected' : '' }}>{{ $material->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('material_id')
                                                    <div class="invalid-feedback">
                                    ...
                                    <section class="mt-3">
                                        ...
                                        {{-- 
                                                ...
                                                <div class="form-group mt-15">
                                                    ...
                                                    <input type="text" name="price" value="{{ !empty($webinar) ? $webinar->price : old('price') }}" class="form-control @error('price')  is-invalid @enderror" placeholder="{{ trans('public.0_for_free') }}" required/>
                                                    @error('price')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
