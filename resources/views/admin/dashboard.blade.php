...
@endsection
    ...
    @push('scripts_bottom')
        ...
        <script>
            ...
            var chart,
                classesStatisticsChart = document
                    .getElementById("classesStatisticsChart")
                    .getContext("2d"),
                        netProfitChart = document.getElementById("netProfitChart").getContext("2d");
                        function makeClassesStatisticsChart(t, a, e) {
                            new Chart(classesStatisticsChartSchool, {
                                type: "doughnut",
                                data: {
                                    labels: a,
                                    datasets: [
                                        {
                                            ...
                                            borderWidth: 0,
                                            borderColor: "#6777ef",
                                            backgroundColor: ["#1d3b65", "#1f3b64", "#ffab00"],
                        ...
                        function makeNetProfitChartSchool(t, a, e) {
                        ...
                        function getSaleStatisticsDataSchool(t) {
                            $.post("/admin/marketing/getNetProfitChart", { type: t }, function (t) {
                                t &&
                                    200 == t.code &&
                                    (chart && chart.destroy(),
                                    makeNetProfitChart("Sale", t.chart.labels, t.chart.data));
                            });
                        }
                        !(function () {
                            "use strict";
