                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="upload-container">
                                ...
                                <div class="uploaded-images">
                                    ...
                                    <img src="https://assets.lls.fr/books/978-2-37760-147-9-MA2_P_2019.png" width="120">
                                    <img src="https://www.editions-hatier.fr/sites/default/files/couvertures/couverture_7512835.jpg" width="120">
                                    <img src="https://revision.ci/assets/uploads/anals/882bb-mon-livre-de-mathematiques-2ndc.png" width="120">

                                    <img src="https://images.epagine.fr/778/9782013954778_1_75.jpg" width="120">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <div style="height: 300px;" class="region-map mt-2" id="mapBox" data-latitude="{{ $latitude }}" data-longitude="{{ $longitude }}" data-zoom="{{ (!empty($region) and $region->type !== \App\Models\Region::$country and $region->type !== \App\Models\Region::$province and !empty($region->geo_center)) ? 12 : 5 }}">
...
<script>
    var selectProvinceLang = '{{ trans('
    update.select_province ') }}';
    var selectCityLang = '{{ trans('
    update.select_city ') }}';
