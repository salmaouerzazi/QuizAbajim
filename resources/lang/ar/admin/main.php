...
'minutes_to_open_account' => 'الدقائق لفتح الحساب',
'minutes_to_open_account_hint' => 'الوقت الذي يمكن للمستخدم فتح حساب بعد التسجيل.',
'online_offline' => 'الحالة عبر الإنترنت/غير متصل',
    'video_instructors' => 'مدربي الفيديو',
    'total_instructors_without_videos' => 'إجمالي المدربين بدون فيديوهات',
    'edit' => 'تعديل ب',
    'minutes_to_open_account' => 'الدقائق لفتح الحساب',
    'minutes_to_open_account_hint' => 'الوقت الذي يمكن للمستخدم فتح حساب بعد التسجيل.',
    'online_offline' => 'الحالة عبر الإنترنت/غير متصل',
