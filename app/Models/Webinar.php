...
class Webinar extends Model implements TranslatableContract
{
    ...
    /**
     * Get the user that teaches the Webinar
     */
    ...
    public function level(){
        ...
        /**
     * Relationship with Submaterial.
     */
    public function submaterial()
    {
        return $this->belongsTo(Submaterial::class, 'submaterial_id');
    }
    ...
    {
        return url('/panel/webinars/allcourses/slug/' . $this->slug);
    }
