...
class RegionController extends Controller
{
    ...
    public function createregionsmanualscolaire(Request $request)
    {
        $this->authorize('admin_regions_create');
      ...
      //  $cities =Region::where("country_id", 72)->where("type", 'city')->orderBy("title")->get();
        ...
        $pdf = new Fpdi();
        $pdf->AddPage();
        $pdfFilePath = public_path('/assets/ManuelScolaire/bac_sci/4sc_t1.pdf');
       ...
       $iconFilePath = public_path('pdf/play-button.png');
       $pdf->Image($iconFilePath, $xPosition ,  $yPosition , 10, 10, 'PNG');
       $pdf->Output('F', 'Mathematique222.pdf');
       $pdfPath = 'Mathematique222.pdf'; 
    ...
    //    $pdf->Write(0, 'This is just a simple text');
       // $pdfPath="/assets/ManuelScolaire/bac_sci/4sc_t1.pdf";
        ...
        return view('admin.regions_manual_scolaire.index', $data);
    }
    public function createregionsmanualscolairepost(Request $request)
    {
    ...
    public function addsmanualscolaire(Request $request)
    {
        $type = $request->get('type');
        $countries = null;
      ...
      //  $cities =Region::where("country_id", 72)->where("type", 'city')->orderBy("title")->get();
        ...
        return view('admin.regions_manual_scolaire.Textbook.add', $data);
    }
    public function indexsmanualscolaire($pageType)
    {
        $pageTypes = [
            'countries' => Region::$country,
            'provinces' => Region::$province,
        ...
        return view('admin.regions_manual_scolaire.Textbook.index', $data);
    }
