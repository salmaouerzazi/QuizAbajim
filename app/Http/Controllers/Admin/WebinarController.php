...
class WebinarController extends Controller
{
    ...
    {
              if($request->fff=='active')
              Webinar::where('id',$id)->update((['status'=>'is_draft']));
              else
              Webinar::where('id',$id)->update((['status'=>'active']));
    ...
    public function index(Request $request)
    {
        ...
        $totalPendingWebinars = (clone $query)->where('webinars.status', 'pending')->count();
        $totalDurations = (clone $query)->sum('duration');
   ...
   /**
    ...
    private function filterWebinar($query, $request)
    {
        ...
        $matiere_name = $request->get('matiere_name', null);
        ...
        if (!empty($matiere_name)) {
            $query->whereHas('material', function ($q) use ($matiere_name) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'categories' => $categories,
            'webinar' => $webinar,
            'webinarCategoryFilters' => $webinar->filters,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($publish) {
            sendNotification('notification.course_approved',
             'notification.course_approved_msg', $webinar->teacher_id,
             ['title' => $webinar->title]);
            ...
            sendNotification(
                ...
                'notification.course_rejected_msg', $webinar->teacher_id,
                null,
                'system',
                'single',
                ['title' => $webinar->title]
