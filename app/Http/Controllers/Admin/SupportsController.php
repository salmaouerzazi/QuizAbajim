...
class SupportsController extends Controller
{
    ...
    {
       // $this->authorize('admin_users_call');
        $users = User::where('role_name', 'organization')->get();
        $support_team = SupportTeam::all();
        return view('admin.supports.call_clients', ['users' => $users, 'support_team' => $support_team]);
    }
